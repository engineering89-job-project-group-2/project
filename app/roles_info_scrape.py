...
# specific html for agile software dev jobs
request = requests.get("https://www.itjobswatch.co.uk/jobs/uk/agile%20software%20development.do")
...
# # print(new_spec_list)
spec_db = pd.DataFrame(new_spec_list, columns=["Category", "6 Months to Now", "Same Period 2020", "Same Period 2019"])
# print(spec_db)
